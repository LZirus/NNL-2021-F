...
structured after tensorflow tutorial
- load data
- pre-process
- ...
...
\lstinputlisting[language=json,firstnumber=1,breaklines,caption={reduced example of saved annotations},captionpos=b, numbers=right]{../code/model.py}
